...
uint8_t encodeOneByte(BufOp bufop, uint64_t value) {
...
template <typename BufOp>
uint16_t encodeTwoBytes(BufOp bufop, uint64_t value) {
...
template <typename BufOp>
uint32_t encodeFourBytes(BufOp bufop, uint64_t value) {
...
template <typename BufOp>
uint64_t encodeEightBytes(BufOp bufop, uint64_t value) {
